...
for name, param in model.features.named_parameters():
    param.requires_grad = True  # you can filter layer names if you want to partially unfreeze

# Replace final classifier with dropout + final layer
...
torch.save(best_model_wts, "best_efficientnet_model.pth")
print("Best model saved as best_efficientnet_model.pth")
